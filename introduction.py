...
# pylint: disable=missing-module-docstring, line-too-long, trailing-whitespace, missing-final-newline
...
async def add_customer_name(ctx: RunContext[CustomerDetails]) -> str:
    """Add customer details to the system prompt.
    Args:
        ctx: Run context containing customer details
    Returns:
        str: Formatted customer details as markdown string
    """
...
def get_shipping_status(order_id: str) -> str:
    ...
    if shipping_status is None:
        raise ModelRetry(
            ...
            "Model retry and self-correct this if needed and try again."
        )

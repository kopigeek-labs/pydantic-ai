...
# __future__ : Python's mechanism for enabling features from future Python versions in current code.
...
async def retrieve(ctx: RunContext[Deps], search_query: str) -> str:
    ...
    """
    with logfire.span('creating embedding for {search_query=}', search_query=search_query):
